...
const ReviewsOnCurrentPage = ({ rev }) => {
    ...
    //lg:w-full md:w-full sm:w-3/4 w-3/4 

    return (
        <div>
            <div className="container flex flex-col max-w-2xl p-6 pt-0 mx-auto divide-y rounded-lg divide-gray-700 bg-gray-900 text-gray-100 mb-4  dark:bg-gray-800 mt-16 lg:w-full md:w-full sm:w-full w-full ">
                <div className="flex justify-between p-4 md:flex-row sm:flex-col flex-col">
                    ...
                    <div className="flex items-center space-x-2 text-yellow-500 sm:ml-20 ml-20 md:ml-0">
