        ...
        <div>
            ...
            <footer className="footer p-8 bg-black text-white mt-64">
                ...
                <div className='px-16'>
                    ...
                    <a className="link link-hover hover:text-blue-600" href='/'>Photography</a>
                    <a className="link link-hover hover:text-blue-600" href='/'>Video Editing</a>
                    <a className="link link-hover hover:text-blue-600" href='/'>Cinematography</a>
                    <a className="link link-hover hover:text-blue-600" href='/'>Brand Promotion</a>
                </div>

                <div className='px-16'>
                    <span className="footer-title">Company</span>
                    <a className="link link-hover hover:text-blue-600" href='/'>About Us</a>
                    <a className="link link-hover hover:text-blue-600" href='/'>Contact</a>
            ...
            <footer className="footer px-16 py-3 border-t bg-black text-white border-base-300">
                ...
                <div className="items-center md:grid-flow-col lg:grid-flow-col sm:grid-flow-row">
                    ...
                    <p ><span className='text-2xl text-orange-400'>Creative Captures</span><br /><span className='text-md text-orange-300'>Providing Photography Services Since 2018</span></p>
                </div>
                ...
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <a href='/' title='Facebook'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current hover:text-blue-700"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
